...
function secondLargest(numbers) {
  // Code here
  //mencari secondlargest adalah menyortir daftar array ke dalam sebuah daftar array secara berurutan dan 
  //memunculkan angka yang keluar sebelum angka terbesar keluar,
  //caranya adalah dengan membuat variabel tampung sementara untuk mengurutkan isi array secara berurutan dan
  //memanggil angka yang keluar sebelum yang terakhir 
var numbers = 0;
    var tampung = [] ; 
